...
#define MAX_GUILD 16+10*6	///Increased max guild members +6 per 1 extension levels [Lupus] //#define MAX_GUILD 16+10*6 default
...
#define MAX_HOMUNCULUS_CLASS	60	//[orn], Increased to 60 from 16 to allow new Homun-S. //#define MAX_HOMUNCULUS_CLASS	52
