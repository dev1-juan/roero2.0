...
{
	if(!sc || !sc->count)
		return cap_value(flee2,10,800); //80% Flee2 Cap [Pinky] [DEFAULT: (flee2,10,SHRT_MAX)]
	...
	return (short)cap_value(flee2,10,800); //80% Flee2 Cap [Pinky] [DEFAULT: (flee2,10,SHRT_MAX)]
}
